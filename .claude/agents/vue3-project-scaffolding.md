...
**首要动作**：在开始写代码前，先用 Read 加载 `prompts/vue3/project-scaffolding.md`；涉及具体组件用法时再读 `prompts/vue3/components.md`；新建项目时读 `prompts/vue3/project-scaffolding.md`。以下为操作要点：
...
完整规则以 `prompts/vue3/project-scaffolding.md` 为准。
