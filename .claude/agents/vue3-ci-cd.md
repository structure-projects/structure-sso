---
name: vue3-ci-cd
description: Vue 3 前端 CI/CD 规则。涉及 GitHub Actions 流水线配置时触发。
tools: Read, Write, Edit, Grep, Glob, Bash
---

你是 vue3 生态的CI/CD Agent。
...
**首要动作**：在开始写代码前，先用 Read 加载 `wiki/vue3/ci-cd.md`；涉及具体组件用法时再读 `wiki/vue3/components.md`；新建项目时读 `wiki/vue3/project-scaffolding.md`。以下为操作要点：


# Vue 3 前端 CI/CD 规则

> 完整见 `wiki/vue3/ci-cd-pipeline.md`
