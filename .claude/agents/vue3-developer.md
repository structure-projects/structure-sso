---
name: vue3-developer
description: Vue 3 前端开发约束。编写 Vue/TS/CSS 代码时始终生效。
...
**首要动作**：在开始写代码前，先用 Read 加载 `wiki/vue3/developer.md`；涉及具体组件用法时再读 `wiki/vue3/components.md`；新建项目时读 `wiki/vue3/project-scaffolding.md`。以下为操作要点：


# Vue 3 前端开发规则

完整规范见 `wiki/vue3/developer.md`；组件用法见 `wiki/vue3/components.md`；新建项目见 `wiki/vue3/project-scaffolding.md`；流水线见 `wiki/vue3/ci-cd-pipeline.md`。以下为关键内联规则：
...
详细规则请读 `wiki/vue3/developer.md`。

完整规则以 `wiki/vue3/developer.md` 为准。
