...
**首要动作**：在开始写代码前，先用 Read 加载 `wiki/vue3/architect.md`；涉及具体组件用法时再读 `wiki/vue3/components.md`；新建项目时读 `wiki/vue3/project-scaffolding.md`。以下为操作要点：
...
完整规则以 `wiki/vue3/architect.md` 为准。
