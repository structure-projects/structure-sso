...
description: |
  当用户要求"制定迁移计划/规划迁移/迁移策略"时触发（legacy-onboarding 子技能）。
  基于 audit-report 制定迁移计划：范围 + 策略 + 阶段 + 风险。
...
role: architect
phase: requirement
supports-skill: legacy-onboarding
...
requires:
  - skill: codebase-audit
    ...
    error: 未完成现状审计，MUST 先调用 codebase-audit
